...
// Definición de estados locales para los campos del formulario.
    ...
    const [airSpeed, setAirSpeed] = useState(''); // Estado para la hora de salida.
...
label="AirSpeed"
value={airSpeed}
onChange={(e) => setAirSpeed(e.target.value)} // Actualiza el estado departureTime.
margin="normal"
/>
...
label="Latitude"
value={latitude}
onChange={(e) => setLatitude(e.target.value)} // Actualiza el estado status.
margin="normal"
/>
